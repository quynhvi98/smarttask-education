$(function() {
  ...
  $('.bar').each(function() {
    ...
    // console.log(phantramcongviec.length );
    ...
    $(this).find('.complete')
      .css('width', (hoanthanh / tongcongviec * 100 + '%'));
    phantramcongviec.text('(' + Math.ceil(hoanthanh / tongcongviec * 100) + '%)');

    if (hoanthanh < tongcongviec / 3) {
    ...
    } else if (hoanthanh > tongcongviec / 3 && hoanthanh < tongcongviec / 2) {
    ...
    } else if (hoanthanh > tongcongviec / 2) {
...
// function resizeDataTable() {
  var orderingDataTable = $('.table.ordering table').DataTable({
    ...
    "initComplete": function() {
      ...
      //   });
      // }
      // var soTrang = $(this).next('.dataTables_paginate');
      // if (soTrang.children().length < 4) {
      //   soTrang.css('display', 'none');
      // } else {
      //   soTrang.css('display', '');
      // }
    }
